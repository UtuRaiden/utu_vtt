    ...
    svg.setAttribute("viewBox", "0 0 200 200"); // Adjust viewBox as needed
    document.body.appendChild(svg); // Or append to a specific element

        function generateHexagonPoints(centerX, centerY, radius) {
        const points = [];
        for (let i = 0; i < 6; i++) {
            const angleDeg = 60 * i - 30; // Adjust starting angle to have a flat top/bottom
